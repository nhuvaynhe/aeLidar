...
class SLlidarNode : public rclcpp::Node
{
  ...
  private:    
    void init_param()
    {
        ...
        this->declare_parameter<int>("serial_baudrate",115200); this->declare_parameter<std::string>("frame_id","lidar_frame"); this->declare_parameter<bool>("inverted", false);
        ...
        this->get_parameter_or<std::string>("frame_id", frame_id, "lidar_frame");
...
int main(int argc, char * argv[])
{
  ...
  auto rplidar_node = std::make_shared<SLlidarNode>();
